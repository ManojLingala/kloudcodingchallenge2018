...
namespace KloudCodingChallenge.Test
{
    public class DataServiceTest
    {
        ...
        [Fact]
        public async Task FetchDataAsync_ShouldNotThowException_WhenServerError()
        {
        ...
        [Fact]
        public async Task FetchDataAsync_ShouldReadDataFromCache_WhenCacheHasData()
        {
            var httpClient = MockHttpClient(null, HttpStatusCode.InternalServerError);
            Mock<ICacheService> mock = new Mock<ICacheService>();
            List<IData> data = new List<IData>()
            {
                new Data() {BrandName = "Brand", Color="Red", OwnerName="Daniel"}
            };
        ...
        [Fact]
        public async Task FetchDataAsync_ShouldUpdateCache_WhenSuccessfulFetchDataAsync()
        {
        ...
        [Fact]
        public async Task FetchDataAsync_ShouldReturn_2Items()
        {
        ...
        [Fact]
        public async Task FetchDataAsync_ShouldReturn_ZeroItems_WhenServiceResponseEmpty()
        {
        ...
        [Fact]
        public async Task FetchDataAsync_ShouldNotCrash_WhenServiceResponseInvalidFormat()
        {
            string json = "[{\"abc\": \"xyz\"}]";
            var httpClient = MockHttpClient(json);
            IDataService service = new DataService(httpClient, serviceConfig, mockCacheService.Object, mockLogger.Object);
        ...
        [Fact]
        public async Task FetchDataAsync_ShouldNotCrash_WhenServiceResponseNotJSONValid()
        {
