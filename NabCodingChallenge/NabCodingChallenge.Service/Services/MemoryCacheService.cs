...
namespace NabCodingChallenge.Service.Services
{
    ...
    public class MemoryCacheService : ICacheService
    {
        ...
        /// <see cref="T:Hiring.Nab.CodeChallenge.Service.Services.MemoryCacheService"/> class.
        /// </summary>
        ...
        public void CacheServiceData(List<IOwner> data)
        {
		...
		public List<IOwner> GetServiceData()
        {
            return this.cache.Get<List<IOwner>>(DATA_CACHE_NAME);
        }

        public void CacheServiceData(List<IData> list)
        {
